...
const About = () => {
  ...
  const logos = [
    ...
    { src: 'src/assets/Logos/icons8-django-96.png', alt: 'Django Logo', delay: 500},
  ...
  return(
    <>
      ...
      <h1 className={`${theme.heading.default} 
        ...
        <div className={`${theme.container.default} ${theme.bodyText.default} mb-0 grid grid-cols-3 gap-9 transform ease-in-out duration-700 ${isDropdown ? 'max-h-[800px]' : 'max-h-28'} overflow-hidden `}>
